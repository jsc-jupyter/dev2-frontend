import { a as require_react, n as require_compiler_runtime, s as __toESM } from "./jsx-runtime-Br9Np9gf.js";
...
function useIncidents() {
	return useSSEStore(_temp4);
}
function _temp4(s) {
	return s.latestStatus?.incidents ?? null;
}
...
function useServerState(serverId) {
	...
	if (progress?.ready ?? false) return "connecting";
	if (isStarting) return "starting";
	if (isStopped) return "stopped";
	if (isStopping) return "stopping";
	if (servers?.stopped?.includes(serverId) === false) return "running";
	return "unknown";
}
function _temp9(s) {
	return s.latestStatus?.servers;
}
export { useServerState as i, useSSEStore as n, useServerProgress as r, useIncidents as t };

//# sourceMappingURL=SSEStore-DAupvT8-.js.map