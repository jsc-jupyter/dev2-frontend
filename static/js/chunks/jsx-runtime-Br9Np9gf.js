...
var require_react_production = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	exports.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE = ReactSharedInternals$3;
	...
	exports.startTransition = function(scope) {
		...
		try {
			...
			null !== prevTransition && null !== currentTransition.types && (prevTransition.types = currentTransition.types), ReactSharedInternals$3.T = prevTransition;
		}
	};
	...
	exports.useSyncExternalStore = function(subscribe, getSnapshot, getServerSnapshot) {
		return ReactSharedInternals$3.H.useSyncExternalStore(subscribe, getSnapshot, getServerSnapshot);
	};
...
var require_react_dom_production = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var ReactSharedInternals$2 = React$1.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;
...
var require_react_dom_client_production = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var isArrayImpl = Array.isArray, ReactSharedInternals$1 = React.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE, ReactDOMSharedInternals = ReactDOM.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE, sharedNotPendingObject = {
		pending: !1,
		data: null,
		method: null,
		action: null
	...
	function useThenable(thenable) {
		...
		null === (null === workInProgressHook ? index$1.memoizedState : workInProgressHook.next) && (index$1 = index$1.alternate, ReactSharedInternals$1.H = null === index$1 || null === index$1.memoizedState ? HooksDispatcherOnMount : HooksDispatcherOnUpdate);
		return thenable;
	}
	function use(usable) {
	...
	function startTransition(fiber, queue, pendingState, finishedState, callback) {
		...
		try {
			...
			ReactDOMSharedInternals.p = previousPriority, null !== prevTransition && null !== currentTransition.types && (prevTransition.types = currentTransition.types), ReactSharedInternals$1.T = prevTransition;
		}
	}
	function noop() {}
	...
	function requestUpdateLane() {
		return 0 !== (executionContext & 2) && 0 !== workInProgressRootRenderLanes ? workInProgressRootRenderLanes & -workInProgressRootRenderLanes : null !== ReactSharedInternals$1.T ? requestTransitionLane() : resolveUpdatePriority();
	}
	...
	function flushPassiveEffects() {
		...
		var renderPriority = lanesToEventPriority(pendingEffectsLanes), prevTransition = ReactSharedInternals$1.T, previousPriority = ReactDOMSharedInternals.p;
		try {
			...
			ReactDOMSharedInternals.p = previousPriority, ReactSharedInternals$1.T = prevTransition, releaseRootPooledCache(root$1, remainingLanes);
		}
	}
...
export { require_react as a, require_react_dom as i, require_compiler_runtime as n, __commonJSMin as o, require_client as r, __toESM as s, require_jsx_runtime as t };

//# sourceMappingURL=jsx-runtime-Br9Np9gf.js.map