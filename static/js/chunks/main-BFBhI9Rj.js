import { a as require_react, i as require_react_dom, n as require_compiler_runtime, s as __toESM, t as require_jsx_runtime } from "./jsx-runtime-Br9Np9gf.js";
...
var offset = (options$1, deps) => {
	const result = offset$1(options$1);
	return {
		name: result.name,
		fn: result.fn,
...
var shift = (options$1, deps) => {
	const result = shift$1(options$1);
	return {
		name: result.name,
		fn: result.fn,
		options: [options$1, deps]
...
var limitShift = (options$1, deps) => {
	return {
		fn: limitShift$1(options$1).fn,
		options: [options$1, deps]
	};
};
var flip = (options$1, deps) => {
	const result = flip$1(options$1);
	return {
		name: result.name,
		fn: result.fn,
		options: [options$1, deps]
...
var arrow = (options$1, deps) => {
	const result = arrow$1$1(options$1);
	return {
		name: result.name,
		fn: result.fn,
		options: [options$1, deps]
...
var Button = (t0) => {
	...
	let t4;
	if ($[0] !== t0) {
		({variant: t1, color: t2, icon, iconPosition: t3, children, className: t4, ...rest} = t0);
		$[0] = t0;
		$[1] = children;
		$[2] = icon;
		$[3] = rest;
	...
	const variant = t1 === void 0 ? "solid" : t1;
	const color = t2 === void 0 ? "primary" : t2;
	const iconPosition = t3 === void 0 ? "before" : t3;
	const className = t4 === void 0 ? "" : t4;
	const isIconOnly = iconPosition === "only" || icon && !children;
	const t5 = `btn btn--${variant} btn--${color} ${isIconOnly ? "btn--icon-only" : ""} ${className}`;
	let t6;
	if ($[8] !== icon || $[9] !== iconPosition) {
		t6 = icon && iconPosition !== "after" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
			className: "btn__icon",
			children: icon
		});
		$[8] = icon;
	...
	const t7 = !isIconOnly && children;
	let t8;
	if ($[11] !== icon || $[12] !== iconPosition) {
		t8 = icon && iconPosition === "after" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
			className: "btn__icon",
			children: icon
		});
		$[11] = icon;
	...
	if ($[14] !== rest || $[15] !== t5 || $[16] !== t6 || $[17] !== t7 || $[18] !== t8) {
		t9 = /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
			className: t5,
			...rest,
			children: [
				t6,
...
export { Presence as A, composeRefs as B, useFocusGuards as C, useCallbackRef as D, DismissableLayer as E, createContextScope as F, Primitive as I, dispatchDiscreteCustomEvent as L, useLayoutEffect2 as M, composeEventHandlers as N, useDirection as O, createCollection as P, createSlot as R, Combination_default as S, FocusScope as T, useComposedRefs as V, Portal2 as _, createRovingFocusGroupScope as a, Trigger2 as b, Content as c, useSize as d, Action as f, Overlay2 as g, Description2 as h, Root as i, useControllableState as j, useId as k, Root2 as l, Content2 as m, getAuthState as n, Anchor as o, Cancel as p, Item as r, Arrow as s, Button_default as t, createPopperScope as u, Root2$1 as v, Portal as w, hideOthers as x, Title2 as y, createSlottable as z };

//# sourceMappingURL=main-BFBhI9Rj.js.map